...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB8     ------> I2C1_SCL
    */
    HAL_GPIO_DeInit(Comunication_SDA_GPIO_Port, Comunication_SDA_Pin);

    HAL_GPIO_DeInit(Comunication_SCL_GPIO_Port, Comunication_SCL_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(Accelerometer_SDA_GPIO_Port, Accelerometer_SDA_Pin);

    HAL_GPIO_DeInit(Accelerometer_SCL_GPIO_Port, Accelerometer_SCL_Pin);
