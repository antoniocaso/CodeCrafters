...
<center>
	<div id="form_pren">
		<form method="post" action="prenotazione.php<?php echo '?id='.$id_tavolo_selezionato.'&dataPrenotazione='.$dataPrenotazione;?>"> 
			<label for="cognome">Cognome<br>
				<input minlength="2" oninput="lengthCheck(this, 20)" autofocus id="cognome" name="cognome" type="text" onkeypress="return onlyCharKey(event)" required/>
			</label>
			<br><br>    
			...
			<input autofocus id="telefono" name="telefono" type="tel"  minlength="9" oninput="lengthCheck(this, 10)" onkeypress="return onlyNumberKey(event)" required/></label>
