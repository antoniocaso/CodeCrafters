...
HD_PWD='C:/consegna/vivado/quadrature_encoder/quadrature_encoder.runs/design_1_quadrature_encoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_quadrature_encoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_quadrature_encoder_0_0.tcl
