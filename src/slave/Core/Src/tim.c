...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(Encoder_ANT_SX1_GPIO_Port, Encoder_ANT_SX1_Pin);

    HAL_GPIO_DeInit(Encoder_ANT_SX2_GPIO_Port, Encoder_ANT_SX2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB4     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(Encoder_ANT_DX2_GPIO_Port, Encoder_ANT_DX2_Pin);

    HAL_GPIO_DeInit(Encoder_ANT_DX1_GPIO_Port, Encoder_ANT_DX1_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, Encoder_POST_SX1_Pin|Encoder_POST_SX2_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Encoder_POST_DX1_Pin|Encoder_POST_DX2_Pin);
