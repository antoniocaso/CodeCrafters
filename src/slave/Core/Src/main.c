...
/* USER CODE BEGIN PFP */
Global_Struct_t Global_Struct_From_Master[PANDA_STRUCT_MASTER_SIZE];
Global_Struct_t Global_Struct[PANDA_STRUCT_GLOBAL_SIZE];
Global_Struct_t Global_Struct_Slave[PANDA_STRUCT_SLAVE_SIZE];
encoder_t EncoderFL;
encoder_t EncoderFR;
encoder_t EncoderBL;
encoder_t EncoderBR;
