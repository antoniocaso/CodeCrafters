...
%
% [y,u,Du,r,d] = mpc_simulate_outputconstraints(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ymax,ymin,ref,dist,noise)
%%  
%% Author: J.A. Rossiter  (email: J.A.Rossiter@shef.ac.uk)

function [y,u,Du,r] = mpc_simulate_outputconstraints(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ymax,ymin,ref,dist,noise)
